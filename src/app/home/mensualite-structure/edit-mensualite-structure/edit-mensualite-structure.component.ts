...
updated_at : [mensualite_structure_to_edit.updated_at],
created_by : [mensualite_structure_to_edit.created_by],
updated_by : [mensualite_structure_to_edit.updated_by]
      });
  }
